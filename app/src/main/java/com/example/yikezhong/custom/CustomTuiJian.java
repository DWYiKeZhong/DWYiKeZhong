 ...
 */
public class CustomTuiJian extends RelativeLayout {
    ...
    public CustomTuiJian(Context context) {
        super(context);
    }

    public CustomTuiJian(Context context, AttributeSet attrs) {
        super(context, attrs);
        View view = LayoutInflater.from(context).inflate(R.layout.custom_tuijian, this, false);
    ...
    public CustomTuiJian(Context context, AttributeSet attrs, int defStyleAttr) {
